...
const TagIcon = () => (
  <svg
    className="w-10 h-10 text-green-700 mb-3"
    fill="none"
    stroke="currentColor"
    strokeWidth={1.5}
    viewBox="0 0 24 24"
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M7 7l10 10M7 17L17 7M7 7v10m10-10v10"
    />
  </svg>
);
...
const TruckIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 17v-2a2 2 0 012-2h6a2 2 0 012 2v2M9 17H7a2 2 0 01-2-2v-5a2 2 0 012-2h2m0 9v-2m0 2h6m0 0v-2m0 2h2a2 2 0 002-2v-5a2 2 0 00-2-2h-2m0 9v-2m0 2h-6"
    />
  </svg>
);
    ...
    <>
      ...
      <main className="bg-gray-50 min-h-screen">
        ...
        <section className="max-w-6xl mx-auto py-12 px-4">
          <h2 className="text-2xl font-semibold mb-8 text-gray-800 animate-fade-in">
            Featured Products
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition animate-fade-in">
              ...
              <p className="text-gray-600">
                Get our premium quality mango powder products for commercial and
                retail use, processed with advanced dehydration technology.
              </p>
            </div>
            <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition animate-fade-in">
              {/* <ChatIcon /> */}
              ...
              <p className="text-gray-600">
                Our friendly support team is always ready to assist you in
                real-time with orders, inquiries, and delivery updates, anytime
                you need.
              </p>
            </div>
            <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition animate-fade-in">
              ...
              <p className="text-gray-600">
                Experience fast and reliable delivery of our products straight
                to your door, ensuring quality, convenience, and satisfaction
                with every order.
              </p>
            </div>
          </div>
